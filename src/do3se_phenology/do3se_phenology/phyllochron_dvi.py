"""Functions specific to the plant Phenology i.e plant life cycle using the JULES/Ewert Phyllochron method.
        ...
        .. code-block:: python
            ...
            1|   |    |   _|_//
             ...
             |   |    |  //
             |   |    | //
            0|___|____|____________________ td
             |   |   //
             |   |  //
             |   | //
            1|   |//
...
from .units import TimeUnit, PiecewiseFunction, Fraction
...
def get_dvi_PLF(
    ...
    DVI = -1 -> 0 for td < tt_emr
    DVI = 0 -> 1 for tt_emr < td < tt_veg
    DVI = 1 -> 2 for tt_veg < td < tt_rep
...
def calc_emergence_rate(
    ...
    """
    if (-0.00001 < t_emerg_to_flag_emerg < 0.00001):
        return 99999999999
    emergence_rate = (nP - 1) / (t_emerg_to_flag_emerg + 0.0001)
...
def calc_dvi_tt_PLF(
    ...
    """Calculates the DVI from the thermal time using interpolation.
