...
class TestExternalStateLoader():
    ...
    class TestNetCDF:
        ...
        class Base:
            ...
            def test_should_be_able_to_get_time_bounds(self):
                ...
                assert out.start_day == self.expected_start_day
                assert out.start_date == self.expected_start_date
                assert out.end_day == self.expected_start_day + math.ceil(self.T / 24) - 1
                assert out.end_date == self.expected_end_date
                assert out.row_count == self.T
        ...
        class TestSingleFileHour(Base):
            ...
            def _setup(self):
                ...
                self.data_location = "examples/net_cdf/single_file_hour/inputs/demo_wrf_2017-12-27-00-00-00"
        ...
        class TestSingleFileHourFollowingYear(Base):
            ...
            def _setup(self):
                ...
                self.data_location = "examples/net_cdf/single_file_hour/inputs/demo_wrf_2018-01-03-23-00-00"
