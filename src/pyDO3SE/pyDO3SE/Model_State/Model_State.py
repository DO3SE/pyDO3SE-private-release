...
class Canopy_Component_State:
    ...
    growing_populations: List[bool] = np.zeros(settings.global_settings.MAX_NUM_OF_LEAF_POPULATIONS)

    #: Thermal time difference between leaf pop emergence and current td
    td_dd_leaf_pops: List[float] = np.zeros(settings.global_settings.MAX_NUM_OF_LEAF_POPULATIONS)
