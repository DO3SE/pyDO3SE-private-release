...
class Config_PnGsto:
    ...
    senescence_method: SenescenceFunctionMethods = SenescenceFunctionMethods.EWERT
    ...
    gamma_3: float = 0.5
    gamma_4_senes: float = 1          # ozone impact on start of senesence (See Ewert for docs)[0-1]
    gamma_5_harvest: float = 0          # ozone impact on end of senesense (See Ewert for docs)[0-1]
