    ...
    try:
        ...
        if options.save_model_processes:
            ...
            dump_model_processes_info_to_file(
                model_processes_out, f"{output_directory}/model_processes.md", detailed=False, allow_errors=True, silent=not verbose)
        if options.save_model_processes_detailed:
            ...
            dump_model_processes_info_to_file(
                model_processes_out, f"{output_directory}/model_processes_detailed.md", allow_errors=True, silent=not verbose)
