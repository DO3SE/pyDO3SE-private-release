...
setups = [
    ...
    RunSetup("long_ozone_damage_dvi_1_86", "long_ozone_damage", "three_days", 'dump_state_dvi_1_86', {}),
    RunSetup("short_ozone_damage_dvi_1_86", "short_ozone_damage", "three_days", 'dump_state_dvi_1_86', {}),
