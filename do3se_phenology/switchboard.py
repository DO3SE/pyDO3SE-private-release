...
def phenology_from_legacy_day_plf(
    ...
    if species_config.leaf_f_phen_method in [
        ...
        # species_config.key_lengths_flag_leaf.leaf_emerg_to_leaf_fst_acc = None # TODO: Se this
        ...
        assert species_config.key_lengths_flag_leaf.leaf_emerg_to_leaf_fst_acc is not None, "key_lengths_flag_leaf.plant_emerg_to_leaf_emerg_knee could not be defined!"
...
def phenology_from_leaf_f_phen_data(
    ...
    key_lengths_flag_leaf_td = PhenologyLeafKeyLengths(
        ...
        leaf_emerg_to_leaf_fst_acc="NOT_IMPLEMENTED",
    )
...
def phenology_from_fphen_td_int(
    ...
    key_lengths_flag_leaf = replace(
        ...
        tl_se=leaf_intervals.t_lse,
        plant_emerg_to_leaf_emerg=emerg_to_flag_emerg,
        plant_emerg_to_leaf_emerg_knee="SET ME!!",
    )
