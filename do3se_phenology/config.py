...
class PhenologyMethods(Enum):
    ...
    FPHEN_JULIAN_DAYS = "fphen_julian_days"
        Define phenology using fphen Julian Day intervals
    ...
    FOREST_LATITUDE = "forest latitude"
        Use forest based latitude function to define phenology
    WHEAT_LATITUDE = "wheat latitude"
        Use wheat based latitude function to define phenology
    ...
    LEAF_FPHEN_DATA = "leaf_fphen_data"
    DEVELOPMENT_INDEX = "development index"
    FOREST_LATITUDE = "NOT IMPLEMENTED"  # "forest latitude"
    WHEAT_LATITUDE = "NOT IMPLEMENTED"  # "wheat latitude"


class LeafPhenologyMethods(Enum):
    """Flag Leaf phenology methods.

    Options
    -------

    AS_CANOPY = "same as canopy"
        Use canopy method.
    """
...
class SpeciesConfig:
    ...
    """
    # Set PRESET to use preset values NOT IMPLEMENTED
...
class ModelConfig:
    ...
    phenology_method_flag_leaf: LeafPhenologyMethods = LeafPhenologyMethods.AS_CANOPY  # NOT IMPLEMENTED
