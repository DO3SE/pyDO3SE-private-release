...
output_fields: Tuple[Field] = (
    ...
    Field('micro_O3', float, 'micro_O3', 'ppb', 'Ozone concentration at top of canopy(top layer)'),
    ...
    Field('A_n_sunlit', float, 'A_n_sunlit', 'umol CO2 m-2 PLA s-1',
          'Net CO2 assimilation rate sunlit component'),
    Field('A_j', float, 'A_j', 'umol CO2 m-2 PLA s-1', 'limited assimilation rate (A_q in paper) '),
    Field('A_c', float, 'A_c', 'umol CO2 m-2 PLA s-1',
          'Rubisco activity limited rate of photosynthesis'),
    Field('A_p', float, 'A_p', 'umol CO2 m-2 PLA s-1',
...
#     TODO: Should change name of yield_ha to g/m^2
    ...
    Field('gsto_l_sunlit', float, 'Gsto_l_sunlit', 'mmol/m^2/s',
          u'Leaf stomatal conductance sunlit only(Gsto_l, mmol/m\u00b2/s)'),
    ...
    Field('gsto_l_bulk', float, 'Gsto_l_Bulk', 'mmol/m^2/s',
          u'leaf stomatal conductance (Leaf Bulk, mmol/m\u00b2/s)'),
    ...
    Field('fst_sun', float, 'Fst Sun', 'nmol/m^2/s', u'Upper leaf stomatal O3 flux for sunlit leaves (Fst, nmol/m\u00b2/s)'),
    ...
    Field('fst_acc_day', float, 'Fst_acc', 'nmol/m^2/s',
          u'Daily Accumulated Upper leaf stomatal O3 flux (Fst_acc, nmol/m\u00b2/s)'),
    ...
    Field('pody_sun', float, 'PODY Sunlit', 'mmol/m^2 PLA',
          u'Accumulated Fst over threshold Y for sunlit leaves (PODY, mmol/m\u00b2 PLA)'),
    ...
    Field('canopy_lai', float, 'Canopy LAI', '', u'Leaf Area Index (LAI, m\u00b2/m\u00b2)'),
    Field('canopy_lai_brown', float, 'Canopy LAI brown leaf', '',
          u'Brown Leaf Area Index (brown_LAI, m\u00b2/m\u00b2)'),
    Field('component_LAI', float, 'LAI_c', '', u'Component Leaf Area Index (LAI, m\u00b2/m\u00b2)'),
    Field('layer_lai', float, 'LAI_layer', '', u'layer Leaf Area Index (LAI, m\u00b2/m\u00b2)'),
    Field('LAI_flag', float, 'LAI_flag', '', u'Flag leaf Leaf Area Index (LAI, m\u00b2/m\u00b2)'),
    Field('fLAI', float, 'fLAI', '', 'Fraction of each layer that is this leaf population (Sums up to 1.0)'),
    Field('canopy_sai', float, 'Canopy SAI', '', u'Stand Area Index (SAI, m\u00b2/m\u00b2)'),

    Field('pet', float, 'PEt', 'm/day',
          'Potential plant transpiration (PEt, m/day)'),

    Field('pet_acc', float, 'PEt_acc', 'm/day',
          'Accumulated Potential plant transpiration (PEt, m/day)'),
    ...
    Field('growing_populations', float, 'iP_growing', '',
