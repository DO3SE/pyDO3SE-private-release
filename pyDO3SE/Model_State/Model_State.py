...
MAX_NUM_OF_CANOPY_LAYERS = int(os.environ.get('MAX_NUM_OF_CANOPY_LAYERS', 4))
MAX_NUM_OF_CANOPY_COMPONENTS = int(os.environ.get('MAX_NUM_OF_CANOPY_COMPONENTS', 1))
MAX_NUM_OF_LEAF_POPULATIONS = int(os.environ.get('MAX_NUM_OF_LEAF_POPULATIONS', 3))
...
class Canopy_Population_State:
    ...
    V_cmax_25_per_layer: List[float] = field(default_factory=lambda: [None for _ in range(
        MAX_NUM_OF_CANOPY_LAYERS)])  #: Maximum catalytic rate at 25 degrees [umol m-2 s-1]
