...
class TestCalcCanopyOzoneConcentration:
    ...
    @pytest.mark.parametrize([
        ...
        (26.961, 20, 454.6, 7.449, 9.304, 0.7873, 0.5486, 1/-0.002034, 20, 27.109, 26.566), # micro O3 should be 35.5
        # This should match emep. Check Ra calcs
        (26.961, 45, 454.6, 7.449, 9.304, 0.7873, 0.5486, 1/-0.002034, 20, 26.961, 26.421), # micro O3 should be 35.5
    ],
    )
...
class TestCalcCanopyOzoneConcentrationAlt:
    ...
    @pytest.mark.parametrize([
        ...
        # (33.904, 2.9348522711, 50.0, 276.901275635,
        # 31.2906856537, 64.121711731, 0.19406299293, 816.99, [33.904, 28.254]),
        (26.961, 20, 454.6, 7.449, 9.304, 0.5486, 1/-0.002034, 10.0, 20, 27.109, 26.566), # micro O3 should be 35.5
        # This should match emep. Check Ra calcs
        (26.961, 45, 454.6, 7.449, 9.304, 0.5486, 1/-0.002034, 10.0, 20, 26.961, 26.421), # micro O3 should be 35.5
    ],
    )
    def test_calc_canopy_ozone_concentration_compare_ui(
        self,
