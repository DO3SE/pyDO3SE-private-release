...
from do3se_phenology.phyllochron_dvi import (
    ...
    get_leaf_phenology_stage,
    get_plant_phenology_stage,
...
class TestPlantPhenologyStage:
    def test_gets_correct_phenology_stages(self):
        ...
        for td in tds:
            next_phenology_stage = get_plant_phenology_stage(
...
class TestLeafPhenologyStage:
    def test_gets_correct_phenology_stages(self):
        ...
        t_lep=20
        t_lse=20
        phenology_stage = get_leaf_phenology_stage(
                0,
                t_lem=t_lem,
                t_lep=t_lep,
                t_lse=t_lse,
        ...
        for td in tds:
            next_phenology_stage = get_leaf_phenology_stage(
                td,
                t_lem=t_lem,
                t_lep=t_lep,
                t_lse=t_lse,
