...
git subtree pull --prefix $PYDO3SE_LOCAL_PATH $PYDO3SE_REMOTE $1 --squash
git subtree pull --prefix $THERMAL_TIME_LOCAL_PATH $THERMAL_TIME_REMOTE $2 --squash
git subtree pull --prefix $DO3SE_PHENOLOGY_LOCAL_PATH $DO3SE_PHENOLOGY_REMOTE $3 --squash
git subtree pull --prefix $DO3SE_MET_LOCAL_PATH $DO3SE_MET_REMOTE $4 --squash
